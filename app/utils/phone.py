from phonenumbers import NumberParseException, PhoneNumberFormat, format_number, is_possible_number, is_valid_number, parse
...
def normalize_phone_number(phone_number: str, default_region: str) -> str:
    try:
